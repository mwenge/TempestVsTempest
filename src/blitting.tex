...
WaitBlit:
  ...
  beq mypal          ; If PAL, skip to mypal.
  add #10,d5         ; We're NTSC so offset Y pos by 10.
mypal:
  move.l #pic5,a0a   ; file 'images/beasty7.cry' again
  move.l #screen3,a1 ; destination we're copying to
  jsr CopyBlock      ; Copy the pixels.
\end{lstlisting}
...
\begin{figure}[H]
    ...
    \begin{adjustbox}{width=6cm,center}
      \frame{\includegraphics[width=3cm]{src/cry/beasty7.png}}%
    \end{adjustbox}
\end{figure}
\end{minipage}
...
\begin{figure}[H]
    \centering
    \begin{adjustbox}{width=5cm,center}
      \frame{\includegraphics[width=5cm]{src/blitting/2000.png}}%
    \end{adjustbox}
\end{figure}
\end{minipage}
