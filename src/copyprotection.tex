...
the game became successful, Atari could fully expect unscrupulous actors to
...
byte and add it to our accumulator giving us an updated value.
\begin{figure}[H]
  {
    ...
    String So Far    &     Byte Value      &  Updated Accumulator.\\
        \midrule
        \includegraphics[width=4cm]{copyprotection/atari_14.png} & \icode{A6}  &  \icode{2B} \\
        \includegraphics[width=4cm]{copyprotection/atari_13.png} & \icode{38}  &  \icode{64} \\
        \includegraphics[width=4cm]{copyprotection/atari_12.png} & \icode{16}  &  \icode{7A} \\
        \includegraphics[width=4cm]{copyprotection/atari_11.png} & \icode{3C}  &  \icode{B6} \\
        \includegraphics[width=4cm]{copyprotection/atari_10.png} & \icode{16}  &  \icode{CC} \\
        \includegraphics[width=4cm]{copyprotection/atari_9.png}  & \icode{00}  &  \icode{CC} \\
        \includegraphics[width=4cm]{copyprotection/atari_8.png}  & \icode{44}  &  \icode{10} \\
        \includegraphics[width=4cm]{copyprotection/atari_7.png}  & \icode{44}  &  \icode{55} \\
        \includegraphics[width=4cm]{copyprotection/atari_6.png}  & \icode{44}  &  \icode{99} \\
        \includegraphics[width=4cm]{copyprotection/atari_5.png}  & \icode{2C}  &  \icode{C5} \\
        \includegraphics[width=4cm]{copyprotection/atari_4.png}  & \icode{2E}  &  \icode{F3} \\
        \includegraphics[width=4cm]{copyprotection/atari_3.png}  & \icode{1A}  &  \icode{0D} \\
        \includegraphics[width=4cm]{copyprotection/atari_2.png}  & \icode{2E}  &  \icode{3C} \\
      \end{tabular}                                                             
    \end{adjustbox}
  }
\end{figure}
...
\begin{figure}[H]
  {
    ...
    String So Far    &     Byte Value      &  Updated Accumulator.\\
        \midrule
        \includegraphics[width=4cm]{copyprotection/atari_1.png}  & \icode{00}  &  \icode{3C} \\
        \includegraphics[width=4cm]{copyprotection/atari_0.png}  & \icode{50}  &  \icode{8C} \\
...
To give us an idea of what 'iterating through a codeblock' actually means, we have
...
With this in hand we can reconstruct the activity of \icode{ZATC4V} as it processes
each byte in the code block, in reverse order, computing a checksum for \icode{QT2}:
...
\begin{figure}[H]
  {
    ...
    Bytes So Far    &     Byte Value      &  Updated Checksum.\\
        \midrule
        \icode{~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~64} & \icode{A6}  &  \icode{2B} \\
        \icode{~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~02, 64} & \icode{A6}  &  \icode{2B} \\
        \icode{~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~20, 02, 64} & \icode{A6}  &  \icode{2B} \\
        \icode{~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~56, 20, 02, 64} & \icode{A6}  &  \icode{2B} \\
        \icode{~~~~~~~~~~~~~~~~~~~~~~~~~~~~04, 56, 20, 02, 64} & \icode{A6}  &  \icode{2B} \\
        \icode{~~~~~~~~~~~~~~~~~~~~~~~~A2, 04, 56, 20, 02, 64} & \icode{A6}  &  \icode{2B} \\
        \icode{~~~~~~~~~~~~~~~~~~~~64, A2, 04, 56, 20, 02, 64} & \icode{A6}  &  \icode{2B} \\
        \icode{~~~~~~~~~~~~~~~~02, 64, A2, 04, 56, 20, 02, 64} & \icode{A6}  &  \icode{2B} \\
        \icode{~~~~~~~~~~~~20, 02, 64, A2, 04, 56, 20, 02, 64} & \icode{A6}  &  \icode{2B} \\
        \icode{~~~~~~~~92, 20, 02, 64, A2, 04, 56, 20, 02, 64} & \icode{A6}  &  \icode{2B} \\
        \icode{~~~~08, 92, 20, 02, 64, A2, 04, 56, 20, 02, 64} & \icode{A6}  &  \icode{2B} \\
        \icode{A2, 08, 92, 20, 02, 64, A2, 04, 56, 20, 02, 64} & \icode{A6}  &  \icode{2B} \\
      \end{tabular}                                                             
    \end{adjustbox}
  }
\end{figure}
