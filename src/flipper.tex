...
presentation of \icode{fverts} to match the way its used:
\begin{lstlisting}
...
\begin{figure}[H]
    ...
    \end{adjustbox}
  \caption{Our three vertices joined together in a triangle. Notice that we\'ve scaled up our co-ordinates by 10. So \icode{(1,3)}, for example, is given as \icode{(10,30)}.}
\end{figure}
