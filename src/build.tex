...
Once the typists had entered your program into the PDP-11 in building 1360, they would see a listing
...
\end{figure}
\vspace{-0.5cm}
Notice how apparently wasteful this file format is: some of the triplets contain only one byte! You can also notice
