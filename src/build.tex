...
\begin{figure}[H]
			\centering
			\frame{\includegraphics[width=10cm]{src/build/codingsheet.png}}%
...
\begin{figure}[H]
			\centering
			\frame{\includegraphics[width=6cm]{src/build/assemble1.png}}%
			\frame{\includegraphics[width=6cm]{src/build/assemble2.png}}%
